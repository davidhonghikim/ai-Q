...
class Context7Client:
    ...
    async def resolve_library_id(self, library_name: str) -> Dict[str, Any]:
        ...
        try:
            ...
            command = self._get_context7_command()
            ...
            # Execute command
            result = await self._execute_mcp_command(command, args, mcp_request)
    ...
    def _get_context7_command(self) -> str:
    ...
    async def _execute_mcp_command(self, command: str, args: List[str], mcp_request: Dict[str, Any]) -> Dict[str, Any]:
